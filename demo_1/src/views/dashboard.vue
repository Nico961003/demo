        ...
        <div class='card'>
          <div class='card-body'>
            ...
            <div class='d-flex flex-column flex-lg-row'>
              ...
              <div class="ml-lg-auto" id="sales-statistics-legend"><div class="chartjs-legend">
                <!-- <ul><li><span style="background-color: #8862e0"></span>Revenue</li><li><span style="background-color: #19d895"></span>Sales</li></ul> -->
                </div></div>
            </div>
