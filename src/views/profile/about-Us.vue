              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="../../assets/images/noavatar.svg" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4 v-if="tokenDecode">{{tokenDecode.preferred_username}}</h4>
                      <p class="text-secondary mb-1">{{tokenDecode.email}}</p>
                      <p class="text-muted font-size-sm">{{tokenDecode.given_name}}</p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      {{tokenDecode.realm_access.roles}}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-12">
                      <router-link class="btn btn-info" :to="'/editUser/' + tokenDecode.sub">Editar</router-link>
